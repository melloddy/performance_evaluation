...
# produced by two classifiers (they are correlated because compued on the same data) described in
# https://protect-de.mimecast.com/s/Cq9ICLZj2GtPEXkvJcqN86Y?domain=stats.stackexchange.com
# Modifications to integrate into WP3 code made by Lewis Mervin
#


# Usage
# Inputs:
# y - array of -1/1 labels (the ground truth)
# yhat0 - scores produced by classifier 0
# yhat1 - scores produced by classifier 1
#
# test_significance() returns an indicator that AUC ROC of classifier1 is stat. sign. higher than that of classifier0 and also
# the p-value
